...
| 4 | Approved-user (magic-link allowlist) management | **Paul, Aiden, and Jessica** can all manage the approved-email list (not Paul-only). |
...
| 10 | Lock/correct authority for weekly reports | **Paul and his designate(s)** — not Paul alone. Requires a configurable "can lock/correct" flag or role addition (e.g. a designated backup), distinct from the general `pm` role held by Aiden/Jessica. |
